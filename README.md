...
[![Portfolio](https://img.shields.io/badge/🌐_Portfolio-FF6B6B?style=for-the-badge&logo=vercel&logoColor=white)](https://portfolio-justin-chi.vercel.app/)
...
<details>
<summary><strong>💻 Previous Roles</strong> <em>(2020 - 2024)</em></summary>

**Web and Mobile Consultant @ Faseya France** *(Fev 2021 - Sept 2024) Part-time*
- Design and implementation of web and mobile applications for companies to improve their business
  
**Frontend Web Developer @ SolvR** *(Fev 2023 - June 2023) Part-time*
- Development of an E-commerce platform for a client in the aviation sector.

**IT Security Consultant @ Smart Corporation** *(Sep 2020 - Dec 2023)*
...
**Technologies:** AWS (EC2, S3, IAM, VPC, RDS), Kubernetes, Docker, Terraform, Helm, ArgoCD, GitHub Actions, Gitlab-CI, Jenkins
